...
object Bridge {
    ...
    external fun nativeLoadW(completable: CompletableDeferred<Unit>, path: String, port: Int, secret: String, withBoard: Boolean)
    external fun nativeStartWriteUi(callBack: UiCallback, processing : String, port: Int, secret: String,
                                    uuid: String, name: String, pType: Int, source: String, interval: Long)

    external fun nativeStopListener()
    external fun nativeStopWriteListener()
