...
object Intents {
    ...
    // wifi changed
    val ACTION_WIFI_CHANGED = "$packageName.intent.action.WIFI_CHANGED"
    ...
    // wifi define
    const val EXTRA_WIFI_BUNDLE = "wifi_bundle"

    val ACTION_WUI_SERVICE_STARTED = "$packageName.intent.action.UI_SERVICE_STARTED"
    val ACTION_WUI_SERVICE_STOPPED = "$packageName.intent.action.WUI_SERVICE_STOPPED"
}