    ...
    override suspend fun run() {
        ...
        while (true) {
            ...
            try {
                ...
                Clash.loadw(service.importedDir.resolve(active.uuid.toString()), store.externalPort, store.externalSecret, store.startWithController).await()
//                Clash.load(service.importedDir.resolve(active.uuid.toString())).await()
//                if (store.startWithController) {
//                    Clash.startController(service.pendingDir, service.processingDir, service.importedDir, store.externalPort, store.externalSecret)
//                }
