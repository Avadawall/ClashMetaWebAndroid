...
abstract class BaseActivity<D : Design<*>> :
    ...
    protected val srvStore by lazy { ServiceStore(this)}
    ...
    protected val uiSrvRunning: Boolean
        get() = Remote.broadcasts.uiSrvRunning

    protected var wifiState: String = "off"
        get() = Remote.broadcasts.wifiState

    protected var ipv4UrlText: String = ""
        get () = Remote.broadcasts.ipv4UrlText
    ...
    override fun onWifiChange(wifiState: String, ipv4UrlText: String) {
            this.wifiState  = wifiState
            this.ipv4UrlText = ipv4UrlText
            events.trySend(Event.WifiChanged)
    }
