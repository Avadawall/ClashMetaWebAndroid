...
class PropertiesActivity : BaseActivity<PropertiesDesign>() {
    ...
    override suspend fun main() {
        ...
        if (original.type == Profile.Type.WebUI) {
            design.uiDesign()
            // if clashrunning is true,
            // broadcasting START_MODIFY_MODULE
            // controllerModule receive START_MODIFY_MODULE
            // if clashrunning is false
        }
